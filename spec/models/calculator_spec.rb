...
describe Calculator do
  it 'object creation' do
    ...
    expect(user_result.user_debt).to eq({ 'user' => 'coach', 'order_total' => 8.00, 'payment_total' => 2.50,
                                          'balance' => 5.50 })
  end
  context 'if a field comes empty' do
    it 'without size of the drink' do
      ...
      expect(user_result.user_debt).to eq({ 'user' => 'coach', 'order_total' => 3.50, 'payment_total' => 2.50,
                                            'balance' => 1.0 })
    end
    it 'without price of the drink' do
      ...
      expect(user_result.user_debt).to eq({ 'user' => 'coach', 'order_total' => 0, 'payment_total' => 2.50,
                                            'balance' => -2.50 })
    end
  end
end
